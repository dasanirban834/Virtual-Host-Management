...
url_start = "https://gitlab.com/api/v4/projects/36759585/repository/files/start%2Ejson?ref=main" # slashes in file path can be replaced by %2F and extension is replaced by %2E
